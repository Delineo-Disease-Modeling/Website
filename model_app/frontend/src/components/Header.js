...
import {UncontrolledDropdown, DropdownToggle, DropdownMenu, Navbar, NavbarBrand, NavbarToggler, Collapse, Nav, NavItem} from 'reactstrap';
          ...
          <Nav navbar className="ms-auto">
            <UncontrolledDropdown>
              ...
              <DropdownMenu id="dropdown-menu" style ={{paddingRight: '8%'}}>
                ...
                <div style = {{marginBottom: '5%', marginLeft: '8%', whiteSpace: 'nowrap'}}>
