...
function DailyChart(props) {
    ...
    const ref = useD3(
        (svg) => {
            ...
            svg.append("text").attr("x", margin.left + (width - margin.left - margin.right) / 2).attr("y", 20).style('fill', 'white').style("text-anchor", "middle").style("font-family", "Montserrat").text("Daily Count v. Time");
