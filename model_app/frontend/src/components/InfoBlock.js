...
const setParams = (subject) => {
  ...
  if (subject === "simulation") {
    ...
    captions[0] =
      "Anytown, USA is an illustrative tool designed to demonstrate the capabilities of the Delineo simulation. ";
    captions[1] =
      "The population, facilities, and layout of Anytown, USA imitate a real-life small town within the US.";
  }
...
const InfoBlock = (props) => {
  ...
  const { title, description, buttontxt, link, images, captions, alts } =
    setParams(props.subject);
