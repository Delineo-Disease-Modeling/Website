const faqData = [
  ...
  },
  {
    ...
    answer:
      "Anytown, USA is a prototype implementation of our simulator, and is meant to let people interact with some of the core features of our simulator while the overall project is still under development.",
  },
  {
    question: "Which programming languages are used on this project?",
    answer:
      "The simulation is written in Python, while our website was created using the MERN stack. The interactive Anytown, USA game was created using the Unity game engine.",
  },
];
