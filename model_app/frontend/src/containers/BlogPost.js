   ...
   return (
    ...
    <div className="App">
      ...
      <div className="center">
        ...
        <p class="text">Currently, this is the proposed structure of the severity risk matrix.</p>
        <figure>
          <div>
            <img src="/blogpostPic4.png" alt=" " title="Severity Risk Matrix" />
            <figcaption>Figure 2 - Severity Risk Matrix</figcaption>
          </div>
        </figure>
        <p class="text">For the remainder of the semester, the simulation team will work on tasks related to the population and submodule representation.
