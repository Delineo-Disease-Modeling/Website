                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={6}>
                            ...
                            <div className={classes.buttonContainer}>
                                <Button className={classes.button} variant="contained" color="inherit" href="/about/#simulation" style={styles.buttonStyle}>
                                    Learn More
                            </Button>
                            </div>
                        </Grid>
                        <Grid item xs={6}>
                            ...
                            <div className={classes.buttonContainer}>
                                ...
                                <Button className={classes.button} variant="contained" color="inherit" href="/about/#simulation">
                                    Learn More
                                    </Button>
                            </div>
                        </Grid>
